...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3fv(glGetUniformLocation(shader.ID, "light.position"), 1, glm::value_ptr(camera.Pos));
        glUniform3fv(glGetUniformLocation(shader.ID, "light.direction"), 1, glm::value_ptr(camera.Front));
        ...
        glUniform1f(glGetUniformLocation(shader.ID, "light.cutoff"), cos(glm::radians(12.5f)));
        glUniform1f(glGetUniformLocation(shader.ID, "light.outCutoff"), cos(glm::radians(17.5f)));
