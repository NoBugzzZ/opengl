...
int main()
{
    ...
    std::vector<float> grassVertices{
        ...
        0.0f, 0.5f, 0.0f, 0.f, 1.f, 0.f, 0.0f, 0.0f,
        0.0f, -0.5f, 0.0f, 0.f, 1.f, 0.f, 0.0f, 1.0f,
        1.0f, -0.5f, 0.0f, 0.f, 1.f, 0.f, 1.0f, 1.0f,

        0.0f, 0.5f, 0.0f, 0.f, 1.f, 0.f, 0.0f, 0.0f,
        1.0f, -0.5f, 0.0f, 0.f, 1.f, 0.f, 1.0f, 1.0f,
        1.0f, 0.5f, 0.0f, 0.f, 1.f, 0.f, 1.0f, 0.0f};
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            float distance = glm::length(camera.Pos - pos);
            sorted[distance] = pos;
        }
