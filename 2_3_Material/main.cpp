...
int main()
{
    ...
    // float centerX = g_width / 2.f;
    // float centerY = g_height / 2.f;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3fv(glGetUniformLocation(shader.ID, "material.ambient"), 1, glm::value_ptr(objectColor));
        glUniform3fv(glGetUniformLocation(shader.ID, "material.diffuse"), 1, glm::value_ptr(objectColor));
        glUniform3fv(glGetUniformLocation(shader.ID, "material.specular"), 1, glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
        ...
        //cyan plastic
        // glm::vec3 ambient{0.0f, 0.1f, 0.06f};
        // glm::vec3 diffuse{0.0f, 0.50980392f, 0.50980392};
        // glm::vec3 specular{0.50196078f, 0.50196078f, 0.50196078};
